package com.qiuhang.changgou.goods.impl;
import com.alibaba.fastjson.JSONObject;
import com.qiuhang.changgou.goods.dao.BrandMapper;
import com.qiuhang.changgou.goods.dao.CategoryMapper;
import com.qiuhang.changgou.goods.dao.SkuMapper;
import com.qiuhang.changgou.goods.dao.SpuMapper;
import com.qiuhang.changgou.goods.pojo.*;
import com.qiuhang.changgou.goods.service.SpuService;
import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.qiuhang.changgou.util.IdWorker;
...
public class SpuServiceImpl implements SpuService {
    ...
    public void put(Long spuId) {
        ...
        if (!spu.getStatus().equals("1")){
            throw new RuntimeException("不能对未审核通过的商品上架");
        }
    ...
    public void audit(Long spuId) {
        Spu spu=spuMapper.selectByPrimaryKey(spuId);
        if (spu.getIsDelete().equals("1")){
            throw new RuntimeException("不能对已删除的商品审核");
        }
        spu.setStatus("1");//审核
        spu.setIsMarketable("1");//上架
        spuMapper.updateByPrimaryKey(spu);
